...
function displayTasks() {
    // Ordenar tareas por prioridad y fecha de vencimiento
    
    tasks.sort((a, b) => {
        // Primero por prioridad (alta, intermedia, baja)
        const priorityOrder = { alta: 3, intermedia: 2, baja: 1 };
        ...
        // Orden descendente por prioridad y ascendente por fecha de vencimiento
